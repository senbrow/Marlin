...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 20*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  // No DIAG jumpers on our mobo since we don't use sensorless homing.
